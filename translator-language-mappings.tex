...
\DeclareOption{simplifiedchinese} {\trans@use@and@alias{simplifiedchinese} {SimplifiedChinese,Chinese}}
%% \DeclareOption{traditionalchinese} {\trans@use@and@alias{traditionalchinese} {TraditionalChinese,Chinese}}
\ProcessOptions*
