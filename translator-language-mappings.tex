...
\DeclareOption{schinese}       {\trans@use@and@alias{schinese} {SimplifiedChinese,Chinese}}
\DeclareOption{tchinese}       {\trans@use@and@alias{tchinese} {TraditionalChinese,Chinese}}
\ProcessOptions*
